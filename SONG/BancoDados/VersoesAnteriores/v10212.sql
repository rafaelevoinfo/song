...
ALTER TABLE NOTIFICACAO
ADD CONSTRAINT UNQ1_NOTIFICACAO
UNIQUE (TIPO);



ALTER TABLE NOTIFICACAO_PESSOA DROP CONSTRAINT FK_NOTIFICACAO_PESSOA_1;
...
ON DELETE CASCADE
ON UPDATE CASCADE
USING INDEX FK_NOTIFICACAO_PESSOA_1;


update conta_pagar set conta_pagar.forma_pagto = 8 where conta_pagar.forma_pagto = 7;

update conta_receber set conta_receber.forma_pagto = 8 where conta_receber.forma_pagto = 7;


ALTER TABLE ATIVIDADE DROP NOTIFICAR_ENVOLVIDOS;
