...
ALTER TABLE ESPECIE
    ADD MES_INICIO_COLETA INTEGER,
    ADD MES_FIM_COLETA INTEGER;
	
update Especie
set Especie.Mes_Inicio_Coleta = extract(month from Especie.Inicio_Periodo_Coleta)
where Especie.Inicio_Periodo_Coleta is not null;

update Especie
set Especie.Mes_Fim_Coleta = extract(month from Especie.Fim_Periodo_Coleta)
where Especie.Fim_Periodo_Coleta is not null;



ALTER TABLE ESPECIE DROP INICIO_PERIODO_COLETA;



ALTER TABLE ESPECIE DROP FIM_PERIODO_COLETA;
