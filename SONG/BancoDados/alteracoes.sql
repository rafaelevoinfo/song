...
ADD CONSTRAINT PK_ENTRADA_ITEM
PRIMARY KEY (ID);

CREATE SEQUENCE GEN_ENTRADA_ITEM;



update RDB$RELATION_FIELDS set
RDB$NULL_FLAG = 1
where (RDB$FIELD_NAME = 'ID_ENTRADA') and
(RDB$RELATION_NAME = 'ENTRADA_ITEM')
;



ALTER TABLE ENTRADA_ITEM
ADD CONSTRAINT FK_ENTRADA_ITEM_1
...
ALTER TABLE ENTRADA_ITEM
ADD CONSTRAINT FK_ENTRADA_ITEM_2
FOREIGN KEY (ID_ITEM)
REFERENCES ITEM(ID)
ON UPDATE CASCADE;
...
ALTER TABLE ENTRADA DROP CONSTRAINT FK_ENTRADA_1;



ALTER TABLE ENTRADA DROP ID_ITEM;



ALTER TABLE ENTRADA DROP QTDE;



ALTER TABLE LOTE_SEMENTE DROP TAXA_DESCARTE;



ALTER TABLE LOTE_SEMENTE
    ADD TAXA_DESCARTE NUMERIC(15,2);
