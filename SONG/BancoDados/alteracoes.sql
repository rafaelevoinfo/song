...
ALTER TABLE MATRIZ
    ADD FOTO BLOB SUB_TYPE 0 SEGMENT SIZE 80;



ALTER TABLE ESPECIE
    ADD QTDE_POR_KILO NUMERIC(15,2);

COMMENT ON COLUMN ESPECIE.QTDE_POR_KILO IS
'Quantidade de sementes por kilo';



update RDB$RELATION_FIELDS set
RDB$NULL_FLAG = 1
where (RDB$FIELD_NAME = 'QTDE_POR_KILO') and
(RDB$RELATION_NAME = 'ESPECIE')
;



ALTER TABLE ESPECIE DROP QTDE_POR_KILO;



ALTER TABLE ESPECIE
    ADD QTDE_SEMENTE_KILO INTEGER NOT NULL;

COMMENT ON COLUMN ESPECIE.QTDE_SEMENTE_KILO IS
'Qtde de sementes por kilo';



UPDATE ESPECIE
SET QTDE_SEMENTE_KILO = 0;
...
CREATE TABLE LOTE (
    ...
    ID_ESPECIE INTEGER NOT NULL,
    QTDE_GRAMAS NUMERIC(15,2) NOT NULL);

ALTER TABLE LOTE
ADD CONSTRAINT PK_LOTE
PRIMARY KEY (ID);

CREATE SEQUENCE GEN_LOTE;



ALTER TABLE LOTE
ADD CONSTRAINT FK_LOTE_1
FOREIGN KEY (ID_PESSOA_COLETOU)
REFERENCES PESSOA(ID)
ON UPDATE CASCADE;
...
alter table LOTE
alter DATA_COLETA position 5;

alter table LOTE
alter QTDE_GRAMAS position 6;



ALTER TABLE LOTE
ADD CONSTRAINT FK_LOTE_2
FOREIGN KEY (ID_ESPECIE)
REFERENCES ESPECIE(ID)
ON UPDATE CASCADE;
...
ALTER TABLE LOTE
    ALTER DATA_COLETA TO DATA;

COMMENT ON COLUMN LOTE.DATA IS
...
'Tipo de acquisicao das sementes
0|null - Coleta
1 - Compra';
...
(RDB$RELATION_NAME = 'LOTE')
;



CREATE TABLE LOTE_MATRIZ (
    ID INTEGER NOT NULL,
    ID_LOTE INTEGER NOT NULL,
    ID_MATRIZ INTEGER NOT NULL);

ALTER TABLE LOTE_MATRIZ
ADD CONSTRAINT PK_LOTE_MATRIZ
PRIMARY KEY (ID);

CREATE SEQUENCE GEN_LOTE_MATRIZ;



ALTER TABLE LOTE_MATRIZ
ADD CONSTRAINT FK_LOTE_MATRIZ_1
FOREIGN KEY (ID_LOTE)
REFERENCES LOTE(ID)
ON UPDATE CASCADE;

ALTER TABLE LOTE_MATRIZ
ADD CONSTRAINT FK_LOTE_MATRIZ_2
...
ALTER TABLE LOTE DROP TIPO;



ALTER TABLE LOTE
    ALTER QTDE_GRAMAS TO QTDE;

COMMENT ON COLUMN LOTE.QTDE IS
'Qtde de smentes coletadas em kilos';



COMMENT ON COLUMN LOTE.QTDE IS
'Qtde de sementes coletadas em kilos';



ALTER TABLE LOTE_MATRIZ DROP CONSTRAINT FK_LOTE_MATRIZ_1;
...
ON DELETE CASCADE
ON UPDATE CASCADE
USING INDEX FK_LOTE_MATRIZ_1;


update ESPECIE
set ESPECIE.NOME = trim(ESPECIE.NOME),
    ESPECIE.NOME_CIENTIFICO = trim(ESPECIE.NOME_CIENTIFICO),
    ESPECIE.FAMILIA_BOTANICA = trim(ESPECIE.FAMILIA_BOTANICA);



ALTER TABLE LOTE
    ADD QTDE_ARMAZENADA NUMERIC(15,2),
    ADD QTDE_SEMEADA NUMERIC(15,2);

ALTER TABLE LOTE
    ALTER QTDE TO QTDE_COLETADA;

COMMENT ON COLUMN LOTE.QTDE_ARMAZENADA IS
'Qtde em kilos de sementes armazenadas';

COMMENT ON COLUMN LOTE.QTDE_SEMEADA IS
'Qtde em kilos de sementes semeadas';



ALTER TABLE LOTE
    ALTER QTDE_COLETADA TO QTDE;

COMMENT ON COLUMN LOTE.QTDE IS
'Qtde de sementes coletadas ou compradas em kilos';
...
CREATE TABLE GERMINACAO (
    ID INTEGER NOT NULL,
    ID_LOTE INTEGER NOT NULL,
    ID_PESSOA_VERIFICOU INTEGER NOT NULL,
    DATA TIMESTAMP NOT NULL,
    QTDE_GERMINADA INTEGER NOT NULL);

COMMENT ON COLUMN GERMINACAO.QTDE_GERMINADA IS
'Qtde de mudas que germinaram ate a data informada';

CREATE SEQUENCE GEN_GERMINACAO;



ALTER TABLE GERMINACAO
ADD CONSTRAINT PK_GERMINACAO
PRIMARY KEY (ID);
...
ALTER TABLE GERMINACAO
ADD CONSTRAINT FK_GERMINACAO_2
FOREIGN KEY (ID_PESSOA_VERIFICOU)
REFERENCES PESSOA(ID)
ON UPDATE CASCADE;
...
ALTER TABLE LOTE
    ADD TAXA_GERMINACAO NUMERIC(15,2),
    ADD TAXA_DESCARTE COMPUTED BY (100-TAXA_GERMINACAO);

COMMENT ON COLUMN LOTE.TAXA_GERMINACAO IS
'Percentual de germinacao desse lote';

COMMENT ON COLUMN LOTE.TAXA_DESCARTE IS
...
CREATE TABLE SEMEADURA (
    ID INTEGER NOT NULL,
    ID_LOTE INTEGER NOT NULL,
    ID_PESSOA_SEMEOU INTEGER NOT NULL,
    QTDE_SEMEADA NUMERIC(15,2) NOT NULL,
    DATA TIMESTAMP NOT NULL,
    OBSERVACAO D_DESCRICAO);

ALTER TABLE SEMEADURA
ADD CONSTRAINT PK_SEMEADURA
PRIMARY KEY (ID);

CREATE SEQUENCE GEN_SEMEADURA;
...
ADD CONSTRAINT PK_CANTEIRO
PRIMARY KEY (ID);

CREATE SEQUENCE GEN_CANTEIRO;



ALTER TABLE SEMEADURA
    ADD ID_CANTEIRO INTEGER NOT NULL;
...
alter table SEMEADURA
alter OBSERVACAO position 7;



ALTER TABLE SEMEADURA
ADD CONSTRAINT FK_SEMEADURA_2
FOREIGN KEY (ID_PESSOA_SEMEOU)
REFERENCES PESSOA(ID)
ON UPDATE CASCADE;

ALTER TABLE SEMEADURA
ADD CONSTRAINT FK_SEMEADURA_3
...
ALTER TABLE CANTEIRO
ADD CONSTRAINT UNQ1_CANTEIRO
UNIQUE (NOME);



ALTER TABLE LOTE DROP QTDE_SEMEADA;
