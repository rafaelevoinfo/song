...
uses
  ...
  IdEMailAddress, IdGlobal, IdExplicitTLSClientServerBase, ShellApi,
  ...
  IdIOHandlerStack, IdSSL, IdSMTPBase;
...
uses
  Vcl.Forms, IdAttachmentFile, System.StrUtils, Winapi.Windows;
...
//      if Pos('@oreades.org.br', FEMail.Configuracao.Usuario) > 0 then
//        FEMail.Configuracao.Usuario := StringReplace(FEMail.Configuracao.Usuario, '@oreades.org.br', '', [rfIgnoreCase]);
