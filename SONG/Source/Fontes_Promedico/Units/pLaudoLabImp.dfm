inherited frmLaudoLabImp: TfrmLaudoLabImp
  Left = 180
  Top = 76
  Caption = 'Impress'#227'o dos Laudos de Exames de Laborat'#243'rio'
  ClientHeight = 496
  ClientWidth = 756
  ...
  object RichTemp: TSRichViewEdit
    Left = 8
    Top = 184
    Width = 740
    Height = 304
    ...
    Version = 'v5.9.6'
    PageProperty.PageViewMode = False
    PageProperty.PageWidth = 210.000000000000000000
    PageProperty.PageHeight = 297.000000000000000000
    PageProperty.LeftMargin = 1.000000000000000000
    PageProperty.RightMargin = 0.010000000000000000
    PageProperty.TopMargin = 0.010000000000000000
    PageProperty.BottomMargin = 1.000000000000000000
    ...
    PageProperty.HeaderY = 1.000000000000000000
    PageProperty.FooterY = 1.000000000000000000
    ...
    ViewProperty.ZoomPercent = 86.000000000000000000
    ViewProperty.ZoomPercentEdit = 100.000000000000000000
    ViewProperty.ZoomPercentIN = -234.809829711914000000
  ...
  object ProfGrid1: TProfGrid
    ...
    Height = 175
    BorderForText = 0
    ClipboardLineBreak = clbSoftEnter
    ColCount = 1
    Color = clWindow
    DefaultDrawing = True
    DefaultRowHeight = 16
    ...
    HeaderFont.Style = []
    Options = [pgoFixedVertLine, pgoFixedHorzLine, pgoVertLine, pgoHorzLine]
    PrintOptions = []
    RowCount = 1
  ...
  object ppImpLaudo: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      mmHeight = 42069
      mmPrintPosition = 0
      object ppImgCabecalho: TppDBImage
        DesignLayer = ppDesignLayer1
        UserName = 'ImgCabecalho'
        AlignHorizontal = ahCenter
        AlignVertical = avCenter
        MaintainAspectRatio = False
        DataField = 'IMG_CABECALHO'
        DataPipeline = ppDBInfoExtras
        GraphicType = 'AutoDetect'
        ParentDataPipeline = False
        DataPipelineName = 'ppDBInfoExtras'
        mmHeight = 13229
        mmLeft = 16404
        mmTop = 1852
        mmWidth = 164836
        BandType = 0
        LayerName = LayerDados
      end
      object ppRichCabecalho: TppDBRichView
        DesignLayer = ppDesignLayer1
        UserName = 'RichCabecalho'
        pmAlinhaTextoCentroV = False
        Caption = 'CABECALHO'
        DataField = 'CABECALHO'
        DataPipeline = ppDBInfoExtras
        ParentDataPipeline = False
    ...
    object ppDetailBand1: TppDetailBand
      ...
      object ppImgAssinatura: TppDBImage
        DesignLayer = ppDesignLayer1
        UserName = 'ImgAssinatura'
        AlignHorizontal = ahCenter
        AlignVertical = avCenter
        MaintainAspectRatio = False
        Stretch = True
        DataField = 'IMG_ASSINATURA'
        DataPipeline = ppDBInfoExtras
        GraphicType = 'AutoDetect'
        ParentDataPipeline = False
        DataPipelineName = 'ppDBInfoExtras'
    ...
    object ppFooterBand1: TppFooterBand
      ...
      mmHeight = 32015
      mmPrintPosition = 0
      object ppRichRodape: TppDBRichView
        DesignLayer = ppDesignLayer1
        UserName = 'RichRodape'
        pmAlinhaTextoCentroV = False
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      mmHeight = 24606
      mmPrintPosition = 0
      object ppRichSumario: TppDBRichView
        DesignLayer = ppDesignLayer1
        UserName = 'RichSumario'
        pmAlinhaTextoCentroV = False
        Anchors = [atLeft, atBottom]
        Caption = 'SUMARIO'
        DataField = 'SUMARIO'
  ...
  object ppDBDados: TppDBPipeline
    ...
    object ppDBDadosppField4: TppField
      FieldAlias = 'USUARIOLIBEROU'
      FieldName = 'USUARIOLIBEROU'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 3
    ...
    object ppDBDadosppField5: TppField
      FieldAlias = 'LARGURA_LAUDO'
      FieldName = 'LARGURA_LAUDO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 4
    ...
    object ppDBDadosppField6: TppField
      FieldAlias = 'ALTURA_LAUDO'
      FieldName = 'ALTURA_LAUDO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 5
    ...
    object ppDBDadosppField7: TppField
      FieldAlias = 'ORDEM_SESSAO'
      FieldName = 'ORDEM_SESSAO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 6
    ...
    object ppDBDadosppField8: TppField
      FieldAlias = 'CODIGO_SESSAO'
      FieldName = 'CODIGO_SESSAO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 7
  ...
  object cdsDados: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'ORDEM_SESSAO;ORDEM_IMPRESSAO;CODIGO;PAGINA'
    Params = <>
    Left = 200
    Top = 352
    ...
    object cdsDadosLAUDO: TBlobField
      FieldName = 'LAUDO'
      ProviderFlags = []
    end
    object cdsDadosORDEM_IMPRESSAO: TIntegerField
      FieldName = 'ORDEM_IMPRESSAO'
    end
    object cdsDadosUSUARIOLIBEROU: TIntegerField
      FieldName = 'USUARIOLIBEROU'
    end
    object cdsDadosLARGURA_LAUDO: TIntegerField
      FieldName = 'LARGURA_LAUDO'
    end
    object cdsDadosALTURA_LAUDO: TIntegerField
      FieldName = 'ALTURA_LAUDO'
    end
    object cdsDadosORDEM_SESSAO: TIntegerField
      FieldName = 'ORDEM_SESSAO'
    end
    object cdsDadosCODIGO_SESSAO: TIntegerField
      FieldName = 'CODIGO_SESSAO'
    end
    object cdsDadosPAGINA: TIntegerField
      FieldName = 'PAGINA'
    end
  end
  ...
  object dsInfoExtras: TDataSource
    DataSet = cdsInfoExtras
    Left = 120
    Top = 272
  end
  object ppDBInfoExtras: TppDBPipeline
    DataSource = dsInfoExtras
    UserName = 'InfoExtras'
    Left = 24
    Top = 272
    object ppDBInfoExtrasppField1: TppField
      FieldAlias = 'IMG_CABECALHO'
      FieldName = 'IMG_CABECALHO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 0
    ...
    object ppDBInfoExtrasppField2: TppField
      FieldAlias = 'CABECALHO'
      FieldName = 'CABECALHO'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object ppDBInfoExtrasppField3: TppField
      FieldAlias = 'RODAPE'
      FieldName = 'RODAPE'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField4: TppField
      FieldAlias = 'SUMARIO'
      FieldName = 'SUMARIO'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField5: TppField
      FieldAlias = 'IMG_ASSINATURA'
      FieldName = 'IMG_ASSINATURA'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 4
    ...
    object ppDBInfoExtrasppField6: TppField
      FieldAlias = 'LEFT_ASSINATURA'
      FieldName = 'LEFT_ASSINATURA'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 5
    ...
    object ppDBInfoExtrasppField7: TppField
      FieldAlias = 'TOP_ASSINATURA'
      FieldName = 'TOP_ASSINATURA'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 6
    ...
    object ppDBInfoExtrasppField8: TppField
      FieldAlias = 'MD5'
      FieldName = 'MD5'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField9: TppField
      FieldAlias = 'CODIGO_EXAME'
      FieldName = 'CODIGO_EXAME'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 8
    ...
    object ppDBInfoExtrasppField10: TppField
      FieldAlias = 'DATA_EXAME'
    ...
    object ppDBInfoExtrasppField11: TppField
      FieldAlias = 'NOME_PROCEDIMENTO'
    ...
    object ppDBInfoExtrasppField12: TppField
      FieldAlias = 'MATERIAL'
      FieldName = 'MATERIAL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField13: TppField
      FieldAlias = 'NROFICHA'
      FieldName = 'NROFICHA'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField14: TppField
      FieldAlias = 'NOME_PACIENTE'
    ...
    object ppDBInfoExtrasppField15: TppField
    ...
    object ppDBInfoExtrasppField16: TppField
    ...
    object ppDBInfoExtrasppField17: TppField
      FieldAlias = 'SEXO'
      FieldName = 'SEXO'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField18: TppField
    ...
    object ppDBInfoExtrasppField19: TppField
    ...
    object ppDBInfoExtrasppField20: TppField
      FieldAlias = 'RG'
      FieldName = 'RG'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField21: TppField
      FieldAlias = 'IDADE'
      FieldName = 'IDADE'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBInfoExtrasppField22: TppField
      FieldAlias = 'MEDICO_SOLICITANTE'
    ...
    object ppDBInfoExtrasppField23: TppField
      FieldAlias = 'CONVENIO'
      FieldName = 'CONVENIO'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object cdsInfoExtras: TClientDataSet
    Aggregates = <>
    FieldDefs = <>
    IndexDefs = <>
    Params = <>
    ...
    Left = 200
    Top = 272
    object cdsInfoExtrasIMG_CABECALHO: TBlobField
      FieldName = 'IMG_CABECALHO'
      ProviderFlags = []
    end
    object cdsInfoExtrasCABECALHO: TBlobField
      FieldName = 'CABECALHO'
      ProviderFlags = []
    end
    object cdsInfoExtrasRODAPE: TBlobField
      FieldName = 'RODAPE'
      ProviderFlags = []
    end
    object cdsInfoExtrasSUMARIO: TBlobField
      FieldName = 'SUMARIO'
      ProviderFlags = []
    end
    object cdsInfoExtrasIMG_ASSINATURA: TBlobField
      FieldName = 'IMG_ASSINATURA'
      ProviderFlags = []
    end
    object cdsInfoExtrasLEFT_ASSINATURA: TIntegerField
      FieldName = 'LEFT_ASSINATURA'
      ProviderFlags = []
    end
    object cdsInfoExtrasTOP_ASSINATURA: TIntegerField
      FieldName = 'TOP_ASSINATURA'
      ProviderFlags = []
    end
    object cdsInfoExtrasMD5: TStringField
      FieldName = 'MD5'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasCODIGO_EXAME: TIntegerField
      FieldName = 'CODIGO_EXAME'
      ProviderFlags = []
    end
    object cdsInfoExtrasDATA_EXAME: TDateTimeField
      FieldName = 'DATA_EXAME'
      ProviderFlags = []
    end
    object cdsInfoExtrasNOME_PROCEDIMENTO: TStringField
      FieldName = 'NOME_PROCEDIMENTO'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasMATERIAL: TStringField
      FieldName = 'MATERIAL'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasNROFICHA: TIntegerField
      FieldName = 'NROFICHA'
      ProviderFlags = []
    end
    object cdsInfoExtrasNOME_PACIENTE: TStringField
      FieldName = 'NOME_PACIENTE'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasESTADO_CIVIL: TStringField
      FieldName = 'ESTADO_CIVIL'
      ProviderFlags = []
      Size = 60
    end
    object cdsInfoExtrasPROFISSAO: TStringField
      FieldName = 'PROFISSAO'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasSEXO: TStringField
      FieldName = 'SEXO'
      ProviderFlags = []
      Size = 60
    end
    object cdsInfoExtrasNATURALIDADE: TStringField
      FieldName = 'NATURALIDADE'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasDATA_NASCIMENTO: TDateTimeField
      FieldName = 'DATA_NASCIMENTO'
      ProviderFlags = []
    end
    object cdsInfoExtrasRG: TStringField
      FieldName = 'RG'
      ProviderFlags = []
    end
    object cdsInfoExtrasIDADE: TStringField
      FieldName = 'IDADE'
      ProviderFlags = []
    end
    object cdsInfoExtrasMEDICO_SOLICITANTE: TStringField
      FieldName = 'MEDICO_SOLICITANTE'
      ProviderFlags = []
      Size = 120
    end
    object cdsInfoExtrasCONVENIO: TStringField
      FieldName = 'CONVENIO'
      ProviderFlags = []
      Size = 120
    end
  end
  object rvHelper: TRVReportHelper
  ...
  object RVStyle: TRVStyle
    ...
    InvalidPicture.Data = {
      ...
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF80
      8080808080FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000
      ...
      
      ...
      
