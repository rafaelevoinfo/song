...
const // campo se primeiro horario é maximo dois digitos
  ...
  ConfiguracoesExtra: array [TConfiguracoesExtra] of string = ('Obrigar preenchimento do CID na baixa do Pronto Atendimento',
    ...
    'Tirar a Obrigatoriedade dos Campos ao Incluir a Ficha pela Internação');
...
begin
  ...
  reEditarValorDiariaTaxa := 'Editar Valor das Diáris e Taxas no Lançamento';
  vaMenuLista.Permissoes.Add(reEditarValorDiariaTaxa);
  reRelAtendimentosFaixaEtaria := 'Rel. Atendimentos por Faixa Etária';
  ...
  inRelAltasCidsDiferentes := 'Rel. Altas com CIDs Diferentes na Internação';
...
{ Terapia }
  ...
  esRelPrecoMatMedConvenio := 'Rel. Preço de Mat/Med por Convênio';
